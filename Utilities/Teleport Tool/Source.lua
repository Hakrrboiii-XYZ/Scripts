...
local Library = {
    Source = loadstring(game:HttpGet("https://scripts.hakrrboiii.xyz/UI/Vynixius/Source.lua"))(),
    Items = {},
}
...
local SelfModules = {
	Directory = loadstring(game:HttpGet("https://scripts.hakrrboiii.xyz/Utilities/main/Directory.lua"))(),
    Discord = loadstring(game:HttpGet("https://scripts.hakrrboiii.xyz/UI/Vynixius/Discord.lua"))(),
    Inviter = loadstring(game:HttpGet("https://scripts.hakrrboiii.xyz/Utilities/Discord%20Inviter/Source.lua"))(),
}
